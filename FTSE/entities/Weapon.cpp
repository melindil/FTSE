...
void Weapon::SetLuaSubclass(lua_State* l)
{
	...
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetEquippedAmmo>()));
	lua_setfield(l, -2, "GetEquippedAmmo");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetMagCapacity>()));
	lua_setfield(l, -2, "GetMagCapacity");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetMinBaseDamage>()));
	lua_setfield(l, -2, "GetMinBaseDamage");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetMaxBaseDamage>()));
	lua_setfield(l, -2, "GetMaxBaseDamage");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetSelectedModeID>()));
	lua_setfield(l, -2, "GetSelectedModeID");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetDamageRadius>()));
	lua_setfield(l, -2, "GetDamageRadius");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetCalledShotSelected>()));
	lua_setfield(l, -2, "IsCalledShot");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetDestroyUser>()));
	lua_setfield(l, -2, "DestroyUser");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetProjectileSprite>()));
	lua_setfield(l, -2, "GetProjectileSprite");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetAmmoType>()));
	lua_setfield(l, -2, "GetAmmoType");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetDefaultAmmoVariant>()));
	lua_setfield(l, -2, "GetDefaultAmmoVariant");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetWeaponPerk>()));
	lua_setfield(l, -2, "GetWeaponPerk");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetPrimaryDamageType>()));
	lua_setfield(l, -2, "GetPrimaryDamageType");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetSecondaryDamageType>()));
	lua_setfield(l, -2, "GetSecondaryDamageType");
	lua_pushcfunction(l, (LuaHelper::THUNK<Weapon, &Weapon::GetSoundType>()));
